<template>
  ...
  <div class="container-fluid">
    ...
    <form class="d-flex">
      <button class="btn me-4 btc" >Upgrade </button>
      <button class="btn btb  " type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell " style="color:white" viewBox="0 0 16 16">
